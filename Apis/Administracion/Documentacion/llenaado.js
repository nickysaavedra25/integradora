document.addEventListener('DOMContentLoaded', function() {
    ...
    function createStudentCard(estudiante) {
        ...
        const docsHtml = generateDocumentsHtml(estudiante.documentos, estudiante.nombre);
     ...
     * @param {string} studentName - Nombre del estudiante para el atributo `data-alumno-nombre`.
     * @returns {string} El HTML generado para los documentos.
     */
    function generateDocumentsHtml(documentos, studentName) {
